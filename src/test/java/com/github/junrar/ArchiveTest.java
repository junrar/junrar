...
public class ArchiveTest {
    ...
    private static Stream<Arguments> provideAudioDecompression() {
        List<String> files =
                Arrays.asList(
                        "audio/BoatModernEnglish-audio-text-unpack30.rar", // special audio/text
                        // compression enabled,
                        // RAR 2.9
                        "audio/BoatModernEnglish-audio-text-unpack20.rar", // special audio/text
                        // compression enabled,
                        // RAR 2.0
                        "audio/BoatModernEnglish-regular-unpack30.rar", // special audio/text
                        // compression disabled, RAR
                        // 2.9
                        "audio/BoatModernEnglish-regular-unpack20.rar", // special audio/text
                        // compression disabled, RAR
                        // 2.0
                        "audio/BoatModernEnglish-regular-unpack15-dos.rar", // special audio/text
                        // compression disabled,
                        // RAR 1.5 DOS
                        "audio/BoatModernEnglish-regular-unpack15-win.rar" // special audio/text
                        // compression disabled,
                        // RAR 1.5 Windows
                        );
