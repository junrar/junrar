...
public class TestCommons {
    ...
    public static File createTempDir() throws IOException {
        return Files.createTempDirectory("Junrar").toRealPath(LinkOption.NOFOLLOW_LINKS).toFile();
    }
    ...
    public static File writeResourceToFolder(File destination, String resourcePath)
            throws IOException {
