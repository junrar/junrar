...
class FileNameDecoderSignednessTest {
    ...
    static Stream<Arguments> highBitCases() {
        return Stream.of(
                ...
                Arguments.of(
                        new byte[] {(byte) 0x85, (byte) 0x00, (byte) 0x9F},
                        0,
                        "case0 unshifted data byte",
                        String.valueOf((char) 0x9F)),
                ...
                Arguments.of(
                        new byte[] {(byte) 0x85, (byte) 0x40, (byte) 0x9A},
                        0,
                        "case1 highByte<<8 plus unshifted data byte",
                        String.valueOf((char) 0x859A)),
                ...
                Arguments.of(
                        new byte[] {(byte) 0x00, (byte) 0x80, (byte) 0x9C, (byte) 0x85},
                        0,
                        "case2 (high<<8)+low with high-bit selector",
                        String.valueOf((char) 0x859C)),
                ...
                Arguments.of(
                        new byte[] {(byte) 0x85, (byte) 0xC0, (byte) 0x05},
                        0,
                ...
                Arguments.of(
                        new byte[] {(byte) 0x85, (byte) 0xC0, (byte) 0x81, (byte) 0x03},
                        0,
    ...
    void givenHighBitSetBytes_whenDecode_thenMatchesHandDerivedOutput(
            byte[] name, int encPos, String description, String expected)
            throws CorruptHeaderException {
        assertThat(FileNameDecoder.decode(name, name.length, encPos))
                .as(description)
                .isEqualTo(expected);
    }
}
