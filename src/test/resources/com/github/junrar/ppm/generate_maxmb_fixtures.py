...
Regenerates hostile-maxmb255.rar next to this script from the already-
...
def main():
    data = bytearray(LEGIT.read_bytes())
    ...
    print(f"patched offset {PATCH_OFFSET}: 0x{BEFORE_BYTE:02x} -> 0x{AFTER_BYTE:02x}")
