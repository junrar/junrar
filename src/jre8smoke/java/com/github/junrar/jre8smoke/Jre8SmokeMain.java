...
public final class Jre8SmokeMain {
    ...
    private static final String AES_RAR =
            "src/test/resources/com/github/junrar/password/rar3-nonascii-password.rar";
    ...
    private static final String RAR5_PLAIN_RAR =
            "src/test/resources/com/github/junrar/rar5unpack/m0-plain-128k.rar";
    ...
    private static final String RAR5_AES_RAR =
            "src/test/resources/com/github/junrar/rar5unpack/m3-enc-hp.rar";
    ...
    public static void main(final String[] args) throws Exception {
        ...
        boolean aesOk =
                check("AES password RAR3", new File(AES_RAR), AES_PASSWORD, AES_ENTRY, AES_SHA256);
        boolean rar5PlainOk =
                check(
                        "plain RAR5",
                        new File(RAR5_PLAIN_RAR),
                        null,
                        RAR5_PLAIN_ENTRY,
                        RAR5_PLAIN_SHA256);
        boolean rar5AesOk =
                check(
                        "AES header-encrypted RAR5",
                        new File(RAR5_AES_RAR),
                        RAR5_AES_PASSWORD,
                        RAR5_AES_ENTRY,
                        RAR5_AES_SHA256);
        ...
        System.out.println(
                "jre8-smoke: OK (java.version=" + System.getProperty("java.version") + ")");
    }
