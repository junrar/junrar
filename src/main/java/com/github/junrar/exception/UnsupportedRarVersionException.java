 ...
 * future"). The ancient RAR 1.4 format (marker {@code 52 45 7e 5e}, unrar {@code RARFMT14})
 * no longer throws this -- {@code Archive} reads its headers through a dedicated loop (P1,
