...
/**
 * RAR 3.x (method 29) decompressor. Extends Unpack20 with PPM and VM filter support.
 *
 * @author $LastChangedBy$
 * @version $LastChangedRevision$
 */
public abstract class Unpack29 extends Unpack20 {
    ...
    protected long writtenFileSize;

    protected boolean fileExtracted;
    ...
    protected void unpack29(boolean solid) throws IOException, RarException {
